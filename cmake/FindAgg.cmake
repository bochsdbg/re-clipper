...
SET(AGG_DIR /usr)
SET(AGG_DIR_BIN /usr/bin)
set(AGG_INCLUDE_DIR /usr/include/agg2)
# If AGG was found, load the configuration file to get the rest of the
# settings.
IF( AGG_DIR_BIN OR AGG_DIR)
...
#    SET( AGG_LIBRARIES ${AGG_LIBRARIES} ${AGG_LIBRARY_aggctrl} )
    ...
    FIND_LIBRARY(AGG_LIBRARY_aggplatform
      NAMES aggplatform aggplatformsdl aggplatformX11
      PATHS
      ${AGG_DIR}
      PATH_SUFFIXES lib64 lib
    )
